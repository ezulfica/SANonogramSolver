...
count_conflit = function(X, r_clues, c_clues, nrows, ncols){
    ...
    #same as the rows, for the columns  
    ...
    #Looking for the vectorial coordinate of every black cells 
    #that are in the rows or cols with too many cells 
    #and every white cells for the ones that are missing somes
